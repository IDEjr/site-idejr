      ...
      <div className={styles.cabecalho}>
        ...
        <nav className={styles.navbar} ref={navRef}>
          <h3
            ...
            onClick={() => handleMove("sobre", navRef, barsRef, timesRef)}
          >
            Sobre
          </h3>
          <h3
            className={styles.sections}
            onClick={() => handleMove("portfolio", navRef, barsRef, timesRef)}
          >
            Portfólio
          </h3>
          <h3
            className={styles.sections}
            onClick={() => handleMove("produtos", navRef, barsRef, timesRef)}
          >
            Produtos
          </h3>
          <h3
            className={styles.sections}
            onClick={() => handleMove("contato", navRef, barsRef, timesRef)}
          >
            Contato
          </h3>
        </nav>
      ...
      <div className={styles.hero}>
        ...
        <div className={styles.inicio}>
          <h1 className={styles.titulo}>
            Experiência em desenvolvimento web & sistemas sob encomenda
          </h1>
